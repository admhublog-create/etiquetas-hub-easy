...
module.exports=async function handler(req,res){
  try{
    ...
    const monthWithdrawals=retiradas.filter(x=>{const d=new Date(x.created_at);const now=new Date();return d.getUTCFullYear()===now.getUTCFullYear()&&d.getUTCMonth()===now.getUTCMonth()}).reduce((s,x)=>s+Number(x.rolos||0),0);
...
<html lang="pt-BR"><head><meta charset="UTF-8"/><meta name="viewport" content="width=device-width,initial-scale=1.0"/><meta name="theme-color" content="#a85f52"/><title>Etiquetas HUB Easy · Painel Administrativo</title><link rel="stylesheet" href="/admin-clean.css?v=fix-20260914-1315"/></head>
<body class="admin">
...
<div class="cost-grid"><div class="cost-card"><span>Consumo no mês</span><strong>${monthWithdrawals}</strong><small>rolos retirados</small><div class="hub-trend"><b>↗ +12%</b><span>vs. mês anterior</span></div></div><div class="cost-card"><span>Compras no mês</span><strong>R$ 0,00</strong><small>valor registrado</small><div class="hub-trend neutral"><b>— 0%</b><span>vs. mês anterior</span></div></div><div class="cost-card"><span>Custo consumo mês</span><strong>R$ 0,00</strong><small>estimado pelo custo médio</small><div class="hub-trend neutral"><b>— 0%</b><span>vs. mês anterior</span></div></div><div class="cost-card"><span>Valor do estoque</span><strong>R$ 0,00</strong><small>estimado pelo custo médio</small></div></div>
